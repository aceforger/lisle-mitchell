          ...
          {book.map((bookItem, i) => (
            ...
            >
              <div
                ...
                onClick={() => setSelectedBook(bookItem)}
              >
                {/* Cover Area with Spin → Stop → Pulse */}
                <div className="bg-gradient-to-b from-[#160D22] to-transparent p-6 flex items-center justify-center relative min-h-[280px]">
                  <div className="absolute top-3 left-3 z-10 px-2.5 py-1 bg-[#FF4FA3] text-white text-xs font-inter font-bold tracking-wider uppercase rounded-full">
                    {bookItem.statusText}
                  </div>
                    ...
                    <img
                      ...
                      onError={(e) => {
                        ...
                        e.target.parentElement.innerHTML = `
                          <span class="text-4xl font-cinzel text-[#FF4FA3]">S</span>
                        `;
                      }}
                    />
                  </motion.div>
