...
//                   i === authorInfo.highlights.length - 1 ? "sm:col-span-2" : ""
//                 }`}
//               >
...
export default function About() {
  ...
  // Intersection Observer - start typing when About section is visible
  useEffect(() => {
  ...
  // Type each title once, then keep it
  useEffect(() => {
    ...
    const typeNext = () => {
      ...
      setActiveTyping(currentTitle);

      if (charIndex < currentTitle.length) {
        currentText = currentTitle.slice(0, charIndex + 1);
        charIndex++;
  ...
  const getTitle = (title) => {
    if (!hasStarted) return title;
    if (displayedTitles[title] === undefined) return "";
    return displayedTitles[title];
  };

  const isTyping = (title) => activeTyping === title;

  return (
    <section
      id="about"
      className="py-24 bg-[#0D0A1A] relative overflow-hidden"
      ref={observerRef}
    >
      {/* Background decorations */}
      <div className="absolute top-0 left-0 w-full h-[1px] bg-gradient-to-r from-transparent via-[#FF4FA3]/40 to-transparent"></div>
      ...
      <div className="max-w-6xl mx-auto px-6 relative z-10">
        ...
        <div className="max-w-6xl mx-auto space-y-8 mb-12">
          ...
          <div className="bg-gradient-to-r from-[#FF4FA3]/5 to-[#B45CFF]/5 backdrop-blur-sm p-8 rounded-2xl border border-[#FF4FA3]/15 hover:border-[#FF4FA3]/40 transition-all duration-500 animate-fade-up group relative overflow-hidden">
            ...
            <div className="flex items-start gap-4 relative z-10">
              ...
              <div>
                <span className="text-[#FF4FA3] font-inter font-bold text-sm tracking-wider uppercase block mb-2 min-h-[20px]">
                  {getTitle("Distinguished Academic Career")}
                  {isTyping("Distinguished Academic Career") && (
                    <span className="inline-block w-[2px] h-4 bg-[#FF4FA3] ml-1 animate-pulse align-middle"></span>
                  )}
                </span>
                <p className="text-white/60 leading-relaxed font-inter text-sm">
                  {authorInfo.bio1}
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-white/[0.03] backdrop-blur-sm p-7 rounded-2xl border border-[#B45CFF]/10 hover:border-[#B45CFF]/40 transition-all duration-500 animate-fade-up-delayed group relative overflow-hidden">
              ...
              <div className="flex items-center gap-3 mb-4 relative z-10">
                ...
                <span className="text-[#B45CFF] font-inter font-bold text-xs tracking-wider uppercase min-h-[16px]">
                  {getTitle("Foundations & Service")}
                  {isTyping("Foundations & Service") && (
                    <span className="inline-block w-[2px] h-3 bg-[#B45CFF] ml-1 animate-pulse align-middle"></span>
                  )}
                </span>
              </div>
              <p className="text-white/50 leading-relaxed font-inter text-sm relative z-10">
            ...
            >
              ...
              <div className="flex items-center gap-3 mb-4 relative z-10">
                ...
                <span className="text-[#FF4FA3] font-inter font-bold text-xs tracking-wider uppercase min-h-[16px]">
                  {getTitle("Career & Leadership")}
                  {isTyping("Career & Leadership") && (
                    <span className="inline-block w-[2px] h-3 bg-[#FF4FA3] ml-1 animate-pulse align-middle"></span>
                  )}
                </span>
              </div>
              <p className="text-white/50 leading-relaxed font-inter text-sm relative z-10">
          ...
          <div className="bg-gradient-to-r from-[#B45CFF]/5 to-[#FF4FA3]/5 backdrop-blur-sm p-8 rounded-2xl border border-[#B45CFF]/15 hover:border-[#B45CFF]/40 transition-all duration-500 animate-fade-up-delayed-2 group relative overflow-hidden">
            ...
            <div className="flex items-start gap-4 relative z-10">
              ...
              <div>
                <span className="text-[#B45CFF] font-inter font-bold text-sm tracking-wider uppercase block mb-2 min-h-[20px]">
                  {getTitle("Post-Retirement Writing & Publications")}
                  {isTyping("Post-Retirement Writing & Publications") && (
                    <span className="inline-block w-[2px] h-4 bg-[#B45CFF] ml-1 animate-pulse align-middle"></span>
                  )}
                </span>
                <p className="text-white/60 leading-relaxed font-inter text-sm">
                  {authorInfo.bio4}
        ...
        <div className="max-w-5xl mx-auto mb-10 animate-fade-up-delayed-2">
          <div className="flex items-center justify-center gap-4 mb-8">
            <div className="w-8 h-[2px] bg-gradient-to-r from-transparent to-[#FF4FA3]/40"></div>
            <h3 className="text-xl font-cinzel text-[#FF4FA3] tracking-wider min-h-[28px]">
              {getTitle("Career Highlights")}
              {isTyping("Career Highlights") && (
                <span className="inline-block w-[2px] h-5 bg-[#FF4FA3] ml-1 animate-pulse align-middle"></span>
              )}
            </h3>
            <div className="w-8 h-[2px] bg-gradient-to-l from-transparent to-[#B45CFF]/40"></div>
          </div>
